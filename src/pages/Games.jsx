  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-2xl mx-auto px-6 py-8 space-y-5">
        ...
        {gameList.map(game => (
          <div key={game.id} className={`bg-white rounded-2xl border ${game.border} shadow-sm overflow-hidden`}>
            <div className="p-5 flex items-start gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="mt-3">
                  <Button onClick={() => setActiveGame(game.id)} className={`bg-gradient-to-r ${game.color} text-white rounded-xl h-9 text-sm hover:opacity-90`}>▶ Play Now</Button>
                </div>
              </div>
            </div>
          </div>
