...
import { Clock, Globe, Lock, Youtube, Search, ArrowLeft, Gamepad2, Play, Zap, Hash, Music, Infinity as InfinityIcon } from 'lucide-react';
import moment from 'moment';
import { useQuery } from '@tanstack/react-query';
import { useNavigate } from 'react-router-dom';
import NekoBrowser from '@/components/NekoBrowser';
      ...
      <main className="max-w-6xl mx-auto px-6 py-6">
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
          ...
          <div className="h-[calc(100vh-270px)]">
            <NekoBrowser
              url={currentTabConfig.url}
              onError={(error) => {
                console.error('Failed to load Neko browser:', error);
                setIframeLoaded(false);
              }}
              onLoad={() => {
                console.log('Successfully loaded Neko browser for', currentTabConfig.label);
