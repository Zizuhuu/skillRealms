...
export default function Dashboard() {
  ...
  const isPro = Boolean(userProfile?.is_pro) || (import.meta.env.VITE_FIREBASE_PROJECT_ID === 'skillway-1125b' && user?.email && localStorage.getItem('skillRealms_pro_user') === user.email);
