...
export default function LessonContent({ subject, lessonNumber, onComplete, isPro }) {
  ...
  useEffect(() => {
    ...
    generateAILesson(subject, lessonNumber).then(result => {
      setAiLesson(result);
      setAiLoading(false);
    });
  }, [subject]);
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col items-center justify-center py-16 space-y-6">
          ...
          <div className="text-center space-y-2">
            <h2 className="text-2xl font-bold text-gray-900">Fetching Personalized Lessons</h2>
            <p className="text-gray-500">Good job for showing up today!</p>
          </div>
